...
const Sidebar: React.FC<SidebarProps> = ({
    ...
    const menuItems = [
        { id: 'PREFLIGHT', label: 'Preflight Check', icon: <Zap className="w-5 h-5" /> },
        { id: 'SIM', label: 'Simulation Mode', icon: <PlayCircle className="w-5 h-5" /> },
        { id: 'LIVE', label: 'Live Trading', icon: <Activity className="w-5 h-5" /> },
