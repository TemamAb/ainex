...
def validate_environment():
    ...
    if not has_private_key:
        print("MONITORING MODE: No PRIVATE_KEY found")
        print("   System will run in monitoring-only mode")
        print("   Profit generation disabled, scanning active")
    else:
        print("EXECUTION MODE: PRIVATE_KEY found")
        print("   Full profit generation enabled")
