...
class EthereumTransferValidator:
    ...
    def get_internal_eth_transfers(self, start_block: int = 0, end_block: int = 99999999,
                                  page: int = 1, offset: int = 100) -> Dict:
        """Get internal ETH transfer transactions (contract calls)"""
        params = {
            'module': 'account',
...
def main():
    ...
    if result['unmatched_expected']:
        print("\n⚠️  UNMATCHED EXPECTED TRANSFERS")
        print("=" * 50)
